...
def update_output_container(report_type, input_year=None):
    if report_type == 'Recession Period Statistics':
        ...
        R_chart2 = dcc.Graph(
            figure=px.bar(average_sales, x='Vehicle_Type', y='Automobile_Sales',
                          title="Average Vehicle Sales by Vehicle Type During Recessions")
        )
    ...
    elif report_type == 'Yearly Statistics' and input_year is not None:
